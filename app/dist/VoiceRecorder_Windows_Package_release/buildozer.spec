...
title = Voice Recorder Scheduler
...
services = VoiceRecorderService:services/service.py
...
# 'aab' files are used to upload app to Google Play Store.
# 'apk' files are used for sideloading and testing purposes.
...
# (list) python-for-android whitelist of recipes to try before defaulting to building from scratch
#p4a.whitelist =

# (bool) indicates whether the bootstrap should try to hook to android logging
p4a.bootstrap = sdl2
